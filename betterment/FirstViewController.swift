...
class FirstViewController: UIViewController, UITableViewDataSource, UITableViewDelegate{
    ...
    var myRootRef = Firebase(url:"https://mitulmanishtest.firebaseio.com/")
    ...
    Person(first_name: "Shal", last_name: "Sajwan", email: "mitul.manish@gmail.com", city: "Melbourne", bio: "anything", skill: [Skill(skill_name: "Dancing", hourly_rate: 56.87, experience: 5)], work: [Work(title: "some random title", description: "desc", related_skill: "Photography", images: ["cutmypic.png"])], profile_image: "people-5.png"),
    ...
    override func viewDidLoad() {
        ...
        myRootRef.setValue("My Data in the cloud.Betterment")
