...
class ChatViewController: JSQMessagesViewController {
    // MARK: Properties
    let rootRef =  Firebase(url: "https://mitulmanishtest.firebaseio.com/messages")
    var messageRef: Firebase!
    var messages = [JSQMessage]()
    
    var receiverId: String = ""
    var senderReceiver: String?
    var receiverSender: String?
    ...
    override func viewDidLoad() {
        ...
        temp.childByAppendingPath(receiverSender).observeEventType(.Value, withBlock: { snapshot in
            if snapshot.exists(){
                ...
                self.messageRef = self.rootRef.childByAppendingPath(self.senderReceiver)
            }
